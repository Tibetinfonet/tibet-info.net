/* compact [
	...
	page=porte_plume_start.js(lang=it)
	page=socialtags.js
	plugins/auto/ahuntsic/js/base.js
] 60.3% */
...
,{"name":"Converti in {{grassetto}}","key":"B","className":"outil_bold","replaceWith":function(h){return espace_si_accolade(h,'{{','}}')},"selectionType":"word"}
,{"name":"Converti in {corsivo}","key":"I","className":"outil_italic","replaceWith":function(h){return espace_si_accolade(h,'{','}')},"selectionType":"word"}
,{"name":"Converti in lista","className":"outil_liste_ul","replaceWith":function(h){return outil_liste(h,'*')},"selectionType":"line","forceMultiline":true,"dropMenu":[{"id":"liste_ol","name":"Converti in lista numerata","className":"outil_liste_ol","replaceWith":function(h){return outil_liste(h,'#')},"display":true,"selectionType":"line","forceMultiline":true}
,{"id":"desindenter","name":"Elimina l'indentazione dela lista","className":"outil_desindenter","replaceWith":function(h){return outil_desindenter(h)},"display":true,"selectionType":"line","forceMultiline":true}
...
,{"separator":"---------------"}
,{"name":"Trasforma in [link ipertestuale->http://...]","key":"L","className":"outil_link","openWith":"[","closeWith":"->[![Indica l'indirizzo del tuo link (puoi indicare un indirizzo internet sotto forma di http://www.miosito.com, un indirizzo di posta elettronica, o semplicemente indicare il numero di un articolo di questo sito.]!]]"}
,{"name":"Trasforma in [[nota a piè pagina]]","className":"outil_notes","openWith":"[[","closeWith":"]]","selectionType":"word"}
,{"separator":"---------------"}
,{"name":"<quote>Cita un messaggio</quote>","key":"Q","className":"outil_quote","openWith":"\n<quote>","closeWith":"</quote>\n","selectionType":"word"}
,{"name":"Racchiudi tra « virgolette »","className":"outil_guillemets","openWith":"«","closeWith":"»","lang":["fr","eo","cpf","ar","es"]
,"selectionType":"word"}
,{"name":"Racchiudi tra “virgolette di secondo livello”","className":"outil_guillemets_simples","openWith":"“","closeWith":"”","lang":["fr","eo","cpf","ar","es"]
,"selectionType":"word"}
,{"name":"Racchiudi tra « virgolette »","className":"outil_guillemets_de","openWith":"„","closeWith":"“","lang":["bg","de","pl","hr","src"]
,"selectionType":"word"}
,{"name":"Racchiudi tra “virgolette di secondo livello”","className":"outil_guillemets_de_simples","openWith":"&sbquo;","closeWith":"‘","lang":["bg","de","pl","hr","src"]
,"selectionType":"word"}
,{"name":"Racchiudi tra « virgolette »","className":"outil_guillemets_simples","openWith":"“","closeWith":"”","lang_not":["fr","eo","cpf","ar","es","bg","de","pl","hr","src"]
,"selectionType":"word"}
,{"name":"Racchiudi tra “virgolette di secondo livello”","className":"outil_guillemets_uniques","openWith":"‘","closeWith":"’","lang_not":["fr","eo","cpf","ar","es","bg","de","pl","hr","src"]
,"selectionType":"word"}
,{"separator":"---------------"}
,{"name":"Inserisci dei caratteri speciali","className":"outil_caracteres","dropMenu":[{"id":"A_grave","name":"Inserisci una A con accento grave maiuscolo","className":"outil_a_maj_grave","replaceWith":"À","display":true,"lang":["fr","eo","cpf"]
}
...
var socialtags=[
{a:'delicious',n:'Del.icio.us',i:'plugins/auto/socialtags/images/delicious.png',u:'http://delicious.com/save?url=%u&title=%t&notes=%d',u_site:'http://www.tibet-info.net/www'},
{a:'digg',n:'Digg',i:'plugins/auto/socialtags/images/digg.png',u:'http://digg.com/submit?phase=2&url=%u&title=%t',u_site:'http://www.tibet-info.net/www'},
{a:'twitter',n:'Twitter',i:'plugins/auto/socialtags/images/twitter.png',u:'http://twitter.com/share?text=%t&url=%u',u_site:'http://www.tibet-info.net/www'}
];
